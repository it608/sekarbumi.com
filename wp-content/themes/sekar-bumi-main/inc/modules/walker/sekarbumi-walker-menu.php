<?php
if (!class_exists('Sekarbumi_Walker_Menu')) {
	class Sekarbumi_Walker_Menu extends Walker_Nav_Menu { 
		...
		public function start_lvl(&$output, $depth = 0, $args = array()) { 
			...
			$output .= "\n$indent<div class=\"uk-navbar-dropdown\"><ul class=\"sub-menu uk-nav uk-navbar-dropdown-nav\">\n";
		}
