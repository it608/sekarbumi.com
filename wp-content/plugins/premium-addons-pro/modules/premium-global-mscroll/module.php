...
class Module extends Module_Base {
	...
	public function register_controls( $element ) {
				...
				'groups'      => array(
					...
					'magic'    => array(
						...
						'options' => array(
							...
							// 'img'       => __( 'Replace Image', 'premium-addons-pro' ),
		...
		// 'condition' => array(
		// 'premium_mscroll_type' => array( 'img' ),
		// ),
		// )
		// );
		...
		$repeater->add_control(
			...
			array(
				...
				'separator' => 'before',
				'condition' => array(
					'premium_mscroll_type!' => array( 'img', 'sequence', 'class', 'font', 'spacing', 'video', 'progress', 'compare', 'fadein', 'fadeout' ),
				),
			)
		);
	...
	public function before_render( $element ) {
		...
		if ( 'yes' === $mscroll_switcher && isset( $settings['premium_mscroll_repeater'] ) ) {
			...
			$element->add_render_attribute(
				...
				array(
					'class'        => 'pa-invisible',
					'data-mscroll' => wp_json_encode( $mscroll_settings ),
				)
			);
